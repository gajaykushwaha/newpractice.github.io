...
";
			...
			$sql = "INSERT INTO `REGISTRATION` (`FNAME`, `LNAME`, `FANAME`, `DOB`, `ADDRS`, `GENDER`, `PHNO`, `EID`, `PASS`,`COURSE`) VALUES ('$fname','$lname','$faname','$dob','$addrs','$gender','$phno','$email','$pass','$course')";
