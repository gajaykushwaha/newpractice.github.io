	...
	<div class="carousel-inner">
		<div class="item active">
			...
			<div class="carousel-caption">
				<a href="registrationform"><h2 style="color: white;"> Today</h2></a>
			</div>
		</div>
		<div class="item">
...
<div class="container" style="max-width: 1200px;">
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">
                    WELCOME TO BANSAL INSTITUTE OF ENGINEERING & TECHNOLOGY 
                </h1>
	...
	<div class="row">
		<div class="col-lg-12">
			<h2 class="page-header">BANSAL INSTITUTE OF ENGINEERING & TECHNOLOGY </h2>
		</div>
		<div class="col-md-6">
			<p>BNSAL INSTITUTE OF ENGINEERING & TECHNOLOGY by <strong>AJAY KUSHWAHA 1842210011,VISHAL SINGH 1842210120,ATUL GUPTA 1842210031</strong> includes:</p>
			<ul>
