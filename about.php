<?php include('allhead.php'); ?>
    ...
    <div class="container" style="max-width: 1200px;">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">About
                    <small>Bansal Institute of Engineering and Technology</small>
                </h1>
                <ol class="breadcrumb">
        ...
        <footer>
                    ...
                    <p class="footer text-center">Copyright &copy; Bansal Institute of Engineering and Technology 2022 <strong>B.tech</strong> project Made by <strong>AJAY KUSHWAHA 1842210011,VISHAL SINGH 1842210120,ATUL GUPTA 1842210031</strong></p>
